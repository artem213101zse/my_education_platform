...
urlpatterns = [
    ...
    path('quiz/<int:quiz_id>/reset/<int:user_id>/', views.reset_quiz, name='reset_quiz'),
    ...
    path('toggle-edit-mode/', views.toggle_preview_mode, name='toggle_edit_mode'),
    path('quiz/<int:quiz_id>/delete/', views.delete_quiz, name='delete_quiz'),
    path('quiz/<int:quiz_id>/add_question/', views.add_question, name='add_question'),
    path('quiz/<int:quiz_id>/answers/<int:user_id>/', views.quiz_user_answers, name='quiz_user_answers'),
